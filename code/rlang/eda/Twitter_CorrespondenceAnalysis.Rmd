...
```{r echo=FALSE}
tweets_eth <- readRDS('tidy_tweets_per_week_eth.rds')
tweets_facebook <- readRDS('tidy_tweets_per_week_facebook.rds')
...
tweets <- rbind(tweets_eth,tweets_facebook)
tweets
...
design <- c(design_eth, design_facebook)
...
color4Authors <- recode(design, D_Ethurium = "RED", D_Facebook="GREEN") #prettyGraphsColorSelection(n.colors = nrow(ci.a))
```
