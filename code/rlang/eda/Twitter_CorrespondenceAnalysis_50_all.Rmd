...
tweets_eth <- readRDS('../../data/tidy_tweets_per_week_n_eth_50.rds')
tweets_facebook <- readRDS('../../data/tidy_tweets_per_week_n_facebook_50.rds')
tweets_bitcoin <- readRDS('../../data/tidy_tweets_per_week_n_bitcoin_50.rds')
